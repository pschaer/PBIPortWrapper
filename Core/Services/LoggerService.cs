...
namespace PBIPortWrapper.Services
{
        ...
        public void Log(LogLevel level, string category, string message, Exception exception = null)
        {
            ...
            lock (_lockObject)
            {
                try
                {
                    ...
                    OnLogMessage?.Invoke(this, new LogEventArgs(level, logEntry, message, category, exception));
                }
                catch
                {
    ...
    public class LogEventArgs : EventArgs
    {
        ...
        public LogEventArgs(LogLevel level, string formattedMessage, string originalMessage, string category, Exception exception = null)
        {
            Level = level;
